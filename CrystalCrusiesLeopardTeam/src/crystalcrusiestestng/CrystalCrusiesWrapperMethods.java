...
public class CrystalCrusiesWrapperMethods {
	...
	public void takeSnap() throws IOException{
		...
		FileUtils.copyFile(src, new File(ScreenshotPath + "CC_"+date2+".jpg"));
	}
	...
	public void invokeApplication() throws InterruptedException, RowsExceededException, WriteException, IOException, BiffException
	{
		try {	
			...
			else if(SauceLabFlag.equalsIgnoreCase("No") && GridFlag.equalsIgnoreCase("No")){
	...
	public static void createWorkbook() throws IOException{
		try {
			...
			workbookCopy = Workbook.createWorkbook(new File(ReportPath + "_" + date3 + ".xls"));
	...
	public static void getIteratorValue(int m){
		k=m;
		j=1;
	}
	...
	{
		try {
			Workbook existingWorkbook = Workbook.getWorkbook(new File(ReportPath + "_" + date3 + ".xls"));
			workbookCopy1 = Workbook.createWorkbook(new File(ReportPath + "_" + date3 + ".xls"), existingWorkbook);
